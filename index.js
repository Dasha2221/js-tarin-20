...
let driveWithCarContext = myCar.drive.bind(myCar);
...
function ElectricCar(brand, model, year, mileage, batteryCapacity) {
  ...
  if (new.target) {
    console.log(new Error("Конструктор має бути викликаний з 'new'"));
  }
 ...
 * | batteryCapacity | 100               |
 */
let myElectricCar = ("Tesla", "Model S", 2020, 10000, 100);
